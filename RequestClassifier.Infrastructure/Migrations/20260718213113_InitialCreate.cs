        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AssignedCategoryId = table.Column<int>(type: "int", nullable: true),
                    ...
                    RequesterPhoneNumber = table.Column<string>(type: "nvarchar(25)", maxLength: 25, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ServiceRequests_RequestCategories_AssignedCategoryId",
                        column: x => x.AssignedCategoryId,
                        principalTable: "RequestCategories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ServiceRequests_RequestCategories_PredictedCategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RequestStatusHistories_ServiceRequests_ServiceRequestId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RequestCategories_Code",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RequestStatusHistories_ServiceRequestId",
                table: "RequestStatusHistories",
                column: "ServiceRequestId");

            migrationBuilder.CreateIndex(
                name: "IX_ServiceRequests_AssignedCategoryId",
                table: "ServiceRequests",
                column: "AssignedCategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_ServiceRequests_PredictedCategoryId",
                table: "ServiceRequests",
